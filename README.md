...
[![Version](https://img.shields.io/badge/Version-v1.1.117-orange.svg)](https://github.com/celsiainternet/elvis/releases)
...
```bash
go get github.com/celsiainternet/elvis@v1.1.117
```
