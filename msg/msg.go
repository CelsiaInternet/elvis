...
const (
	...
	MSG_VALIDATE_KIND       = "Tipo de verificación no valido"
	MSG_CODE_UNVERIFY       = "El código de verificación es incorrecto"
	MSG_EXECUTED_SUCCESS    = "Codigo verificado con éxito"
