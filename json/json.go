...
func (jb Json) Json(atrib string) Json {
	...
	case map[string]interface{}:
		return Json(v)
	default:
		logs.Errorf("Json. Type (%v) value:%v", reflect.TypeOf(v), v)
		return Json{}
	}
}
...
func (jb Json) Array(atrib string) []Json {
	...
	case []interface{}:
		...
		if err != nil {
			logs.Errorf("Array. Type (%v) value:%v", reflect.TypeOf(v), v)
			return []Json{}
		}
...
func (jb Json) ArrayStr(atrib string) []string {
	...
	default:
		logs.Errorf("ArrayStr Type (%v) value:%v", reflect.TypeOf(v), v)
	}
...
func (jb Json) ArrayAny(atrib string) []any {
	...
	default:
		logs.Errorf("ArrayAny Type (%v) value:%v", reflect.TypeOf(v), v)
	}
