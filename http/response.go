...
func Error(w http.ResponseWriter, r *http.Request, statusCode int, message string) error {
	msg := et.Json{
		"message": message,
	}
...
func Alert(w http.ResponseWriter, r *http.Request, message string) error {
	return Error(w, r, http.StatusBadRequest, message)
}
...
func Upload(r chi.Router, path string, root http.FileSystem) {
